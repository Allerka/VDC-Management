          ...
          >
              ...
              <div className="d-flex flex-row-fluid flex-column justify-content-between ">
                ...
                <Link to="/" className="flex-column-auto mt-5">
                  <img
                      ...
                      src={toAbsoluteUrl("/media/fev-logo.png")}
                  />
                </Link>
                {/* end:: Aside header */}
                ...
                <div className="flex-column-fluid d-flex flex-column justify-content-center">
                  <h3 className="font-size-h1 mb-5 text-white stroke">
                    {/* VDC Management */}
                  </h3>
                  <p className="font-weight-bold font-size-h4 text-white stroke">
                    {/* Beta Build v0.1.2 */}
                  </p>
                </div>
                {/* end:: Aside content */}
                ...
                <div className="d-none flex-column-auto d-lg-flex justify-content-between mt-10">
                  {/* <div className="font-weight-bold font-size-h4 text-white stroke">
                    &copy; FEV Operations Team | Beta Build v0.1.3
                  </div> */}
            ...
            <div className="flex-row-fluid d-flex flex-column position-relative p-7 overflow-hidden">
              ...
              <div
                ...
                {/* <div className="text-dark-50 font-weight-bold order-2 order-sm-1 my-2 stroke">
                  &copy; FEV Operations Team | Beta Build v0.1.3
                </div> */}
